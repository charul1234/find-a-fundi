...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        {!! Form::open(['method' => 'POST','files'=>true,'route' => ['admin.categories.store'],'class' => 'form-horizontal','id' => 'frmCategory']) !!}
        ...
        <div class="card-body">
            <div class="form-group {{$errors->has('parent_id') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::select('parent_id', $categories, old('parent_id'), ['id'=>'parent_id', 'class' => 'form-control', 'placeholder' => 'Select Parent Category']) !!}
