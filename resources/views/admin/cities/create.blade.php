...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        {!! Form::open(['method' => 'POST','files'=>true,'route' => ['admin.cities.store'],'class' => 'form-horizontal','id' => 'frmCity']) !!}
        ...
        <div class="card-body">  
            <div class="form-group {{$errors->has('country_id') ? ' has-error' : ''}}">
                    ...
                    <div class="col-md-6">
                    {!! Form::select('country_id', $countries, old('country_id'), ['id'=>'country_id', 'class' => 'form-control', 'placeholder' => 'Select Country']) !!}
            ...
            <div class="form-group {{$errors->has('title') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                <label class="col-md-6 control-label" for="title">Title <span style="color:red">*</span></label>
                 <div class="col-md-6">
