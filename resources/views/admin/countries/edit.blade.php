...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        {!! Form::open(['method' => 'POST','files'=>true,'route' => ['admin.countries.update',$country->id],'class' => 'form-horizontal','id' => 'frmCountry']) !!}
            @method('PUT')
        ...
        <div class="card-body">            
            <div class="form-group {{$errors->has('title') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                <label class="col-md-3 control-label" for="title">Name <span style="color:red">*</span></label>
                 <div class="col-md-6">
                    {!! Form::text('title', old('title',$country->title), ['class' => 'form-control', 'placeholder' => 'Name']) !!}
                    @if($errors->has('title'))
            ...
            <div class="col-md-12 form-group">
                        ...
                        <label for="is_default">{{ Form::checkbox('is_default', '1', old('is_default',isset($country->is_default)?$country->is_default:0),['id'=>'is_default']) }} Default</label>
                    </div>
        </div> 
