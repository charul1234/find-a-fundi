...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        {!! Form::open(['method' => 'POST','files'=>true,'route' => ['admin.faqs.store'],'class' => 'form-horizontal','id' => 'frmFaq']) !!}
        ...
        <div class="card-body">      
            ...
            <div class="form-group {{$errors->has('discription') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                <label class="col-md-3 control-label" for="address">Description <span style="color:red">*</span></label>
                <div class="col-md-9">
                    {!! Form::textarea('description',old('description'), ['class' => 'form-control', 'placeholder' => 'Description','class'=>'ckeditor']) !!}
