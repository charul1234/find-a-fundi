    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="form-group {{$errors->has('address') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::textarea('address',old('address',$user->address), ['class' => 'form-control', 'placeholder' => 'Address','rows'=>'1']) !!}
            ...
            <div class="form-group {{$errors->has('latitude') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::text('latitude',old('latitude',$user->latitude), ['class' => 'form-control', 'placeholder' => 'Latitude']) !!}
            ...
            <div class="form-group {{$errors->has('longitude') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::text('longitude',old('longitude',$user->longitude), ['class' => 'form-control', 'placeholder' => 'Longitude']) !!}
